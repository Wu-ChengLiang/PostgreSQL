...
- 不要说"未知错误"，而要根据具体错误类型给出有用的建议""",
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "customer_phone": {
                                "type": "string",
                                "description": "客户电话号码，从客户的最新消息中提取11位手机号。如果客户提供了电话号码，必须提取此字段。优先使用消息中的电话号码，而不是历史记录或上下文中的。"
                            },
                            "store_name": {
                                "type": "string",
                                "description": "门店名称。优先从用户最新消息中获取门店信息，如果未提供，则可使用上下文中的门店。"
                            },
                            "appointment_date": {
                                "type": "string",
