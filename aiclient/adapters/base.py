...
【重要：门店技师查询流程】
当需要查询技师信息时，必须按以下步骤操作：
1. 首先调用 get_stores 获取所有门店列表
2. 根据当前门店名称（如"名医堂·颈肩腰腿特色调理（高岛屋店）"）找到对应的门店ID
3. 然后使用正确的 store_id 调用 search_therapists 搜索该门店的技师
